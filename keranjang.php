...
if (!isset($_SESSION['user_nama'])) { header('Location: login.php'); exit; }
...
<head>
    ...
    <style>
        ...
        a { color: #A98A74; text-decoration: none; font-weight: 600; transition: color 0.3s ease; }
        a:hover { color: #5D4037; }
        .empty-cart { text-align: center; font-size: 1.2rem; color: #777; padding: 40px 0; }
        ...
        .link-hapus { color: #e74c3c; font-size: 0.9rem; font-weight: 600; cursor: pointer; } /* (BARU) Tambahkan cursor:pointer */
        .link-hapus:hover { color: #c0392b; text-decoration: underline; }
        .cart-checkbox { width: 1.3em; height: 1.3em; accent-color: #5D4037; }
        .checkout-footer { position: sticky; bottom: 0; left: 0; width: 100%; background-color: #fff; padding: 20px; box-shadow: 0 -4px 15px rgba(0,0,0,0.08); border-top: 1px solid #F0EAE4; display: flex; justify-content: space-between; align-items: center; margin: 0 -30px -30px -30px; /* Disesuaikan dengan padding .container */ padding-left: 50px; padding-right: 50px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; }
        .checkout-total { text-align: right; }
        .checkout-total span { font-size: 1.3rem; font-weight: 700; color: #5D4037; margin-left: 10px; }
        .btn-checkout { display: inline-block; background: #A98A74; color: #fff; padding: 12px 25px; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 1.1rem; transition: background-color 0.3s ease; border: none; cursor: pointer; }
        .btn-checkout:hover { background: #937460; color: #fff; }
        ...
        body.dark-mode a { color: #A98A74; }
        body.dark-mode a:hover { color: #E6EDF3; }
        body.dark-mode .link-hapus { color: #e74c3c; }
        body.dark-mode .empty-cart { color: #ADBAC7; }
        body.dark-mode .product-img { border-color: #444C56; }
        body.dark-mode .checkout-footer { background-color: #2D333B; border-color: #444C56; }
        body.dark-mode .checkout-total span { color: #E6EDF3; }
    </style>
</head>
<body>
    <div class="container">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <img src="<?php echo htmlspecialchars($produk->getImageUrl()); ?>" alt="<?php echo htmlspecialchars($produk->getNama()); ?>" class="product-img">
                            </td>
                            <td>
