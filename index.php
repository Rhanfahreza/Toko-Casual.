...
foreach ($products as $produk) {
    $kategori_produk[] = $produk->getKategori();
}
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-wishlist .icon-heart-filled {
            display: none;
        }

        .btn-wishlist .icon-heart-empty {
            display: inline-block;
        }

        .btn-wishlist.active .icon-heart-filled {
            display: inline-block;
            color: #e74c3c;
        }

        .btn-wishlist.active .icon-heart-empty {
            display: none;
        }

        .swal2-popup .quick-view-content {
            display: flex;
            gap: 20px;
            text-align: left;
        }

        .swal2-popup .quick-view-image {
            width: 40%;
            flex-shrink: 0;
        }

        .swal2-popup .quick-view-image img {
            width: 100%;
            border-radius: 8px;
        }

        .swal2-popup .quick-view-details {
            flex-grow: 1;
        }

        .swal2-popup .quick-view-details h2 {
            font-size: 1.5rem;
            color: #5D4037;
            margin-bottom: 10px;
        }

        .swal2-popup .quick-view-details .price {
            font-size: 1.3rem;
            font-weight: 700;
            color: #8C6A5A;
            margin-bottom: 15px;
        ...
        .swal2-popup .quick-view-details .stock {
            font-weight: 600;
            margin-bottom: 15px;
        }

        .swal2-popup .quick-view-details .stock.available {
            color: #27ae60;
        }

        .swal2-popup .quick-view-details .stock.unavailable {
            color: #e74c3c;
        }

        .swal2-popup .quick-view-details .description {
            font-size: 0.95rem;
            line-height: 1.6;
            color: #4B4B4B;
        }
        ...
        body.dark-mode #dark-mode-toggle .bi-moon-fill {
            display: none;
        }

        body.dark-mode #dark-mode-toggle .bi-sun-fill {
            display: inline-block;
        }
        ...
        body.dark-mode .btn-wishlist.active .icon-heart-filled {
            color: #e74c3c;
        }
        ...
        body.dark-mode .swal2-popup .quick-view-details h2 {
            color: #E6EDF3;
        }

        body.dark-mode .swal2-popup .quick-view-details .description {
            color: #ADBAC7;
        }
        ...
        @media (max-width: 768px) {
            ...
            .nav-text {
                display: none; /* Sembunyikan teks agar ringkas dengan ikon saja di mobile */
            }
            .welcome-text {
                margin-right: 0;
                display: block;
...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                <li><span class="welcome-text">Halo, <?php echo htmlspecialchars($_SESSION['user_nama']); ?>!</span>
                </li>
                <?php if (isset($_SESSION['user_email']) && $_SESSION['user_email'] === 'admin@gmail.com'): ?>
                    <li><a href="admin.php"><i class="bi bi-shield-lock-fill"></i> <span class="nav-text">Admin</span></a></li>
                <?php endif; ?>
                <li><a href="index.php"><i class="bi bi-house-door-fill"></i> <span class="nav-text">Home</span></a>
                </li>
                <li><a href="keranjang.php"><i class="bi bi-bag"></i> <span class="nav-text">Keranjang (<span
                                id="cart-count"><?php echo $jumlah_item_di_keranjang; ?></span>)</span></a></li>
                ...
                <li><a href="#" id="dark-mode-toggle" title="Toggle Dark Mode"><i class="bi bi-moon-fill"></i><i
                            class="bi bi-sun-fill"></i></a></li>
            </ul>
        </nav>
    </header>
                ...
                <div class="product-card" data-category="<?php echo htmlspecialchars($produk->getKategori()); ?>">
                    <div class="product-image">
                        <img src="<?php echo htmlspecialchars($produk->getImageUrl()); ?>"
                            alt="<?php echo htmlspecialchars($produk->getNama()); ?>">
                        ...
                        <?php if (isset($products[$id_produk])):
                            ...
                            <div class="product-card" data-category="<?php echo htmlspecialchars($produk->getKategori()); ?>">
                                <div class="product-image">
                                    <img src="<?php echo htmlspecialchars($produk->getImageUrl()); ?>"
                                        alt="<?php echo htmlspecialchars($produk->getNama()); ?>">
                                    <a href="quick_view_aksi.php?id=<?php echo $id_produk; ?>" class="btn-quick-view"
                                        title="Lihat Cepat">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click', '#logout-link', function (event) {
                event.preventDefault();
                var logoutUrl = $(this).attr('href'); //  URL (logout.php)
